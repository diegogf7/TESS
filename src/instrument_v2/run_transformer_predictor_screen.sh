...
export FRT_ART_DIR=artifacts/instrument_v2/transformer_predictor_screen
export FRT_CKPT_DIR=/orcd/scratch/orcd/006/diegogon/checkpoints/transformer_predictor_screen
export TEACHER_SELECTION=artifacts/instrument_v2/fixed_regional_teacher_v1/selection_regteacher_k8_s0.json
export PREDICTOR=transformer SELECT_VIEW=predicted
