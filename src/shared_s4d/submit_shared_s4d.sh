...
#SBATCH --mem=128G
#SBATCH -t 08:00:00
#SBATCH -o shared_s4d_%j.out

# Shared-S4D systematics autoencoder: one curve -> 32-D latent -> 1024 systematics,
# trained on leave-one-out group medians. No teacher/EMA/PCA/MAD/JEPA.
#   sbatch -p mit_normal_gpu --export=ALL,REQUIRE_FULL=0 src/shared_s4d/submit_shared_s4d.sh
set -euo pipefail
...
export ART_DIR=${ART_DIR:-artifacts/shared_s4d/systematics_v1}
export CKPT_DIR=${CKPT_DIR:-/orcd/scratch/orcd/006/diegogon/checkpoints/shared_s4d_systematics_v1}
...
"$PY" -m src.shared_s4d.train
echo "=== DONE shared_s4d train ==="
