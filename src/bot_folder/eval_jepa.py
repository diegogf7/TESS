"""
Evaluate the frozen LatentJEPA latent on the real TESS curves (cluster).

Same probe protocol as eval_masked.py. Prints the collapse check (latent std)
and SECTOR / CLASS balanced accuracies.
