...
from src.worked_folder.instrument_jepa import build_instrument_jepa, instrument_jepa_loss
...
for epoch in range(EPOCHS):
    ...
    for batch_idx, (anchor_flux, anchor_mask, ss_flux, ss_mask, same_sector_flux, same_sector_mask) in enumerate(dataloader):
        ...
        prediction, target = model(ss_flux, ss_mask, anchor_flux, anchor_mask)
