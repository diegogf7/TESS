...
Run:
  /Users/diegogonzalez/.tess_local_venv/bin/python -m src.worked_folder.validation.validate_readout
"""
...
from src.worked_folder.validation.validate_synthetic import normalize, probe
