...
CHECKPOINT = os.environ.get("JEPA_CKPT", "/orcd/scratch/orcd/006/diegogon/checkpoints/physics_pair_jepa.pth")
...
run_probe(latents, all_sectors, "z_inst --> SECTOR (want low, generic encoder 0.54 - 0.62)")
run_probe(latents, all_labels,  "z_inst --> CLASS  (want high, bars: ms16 0.688 / masked 0.463)", groups=all_tics)